...
`chatclash --tree` renders the command tree from the registered Click command object. This page lists implemented, reachable commands only; planned capabilities must not appear as successful CLI leaves.
