...
def render_cli_tree(command: click.Command, *, root_name: str = "chatclash") -> str:
...
def _print_tree(ctx: click.Context, _param: click.Parameter, value: bool) -> None:
    if not value or ctx.resilient_parsing:
        return
    click.echo(render_cli_tree(ctx.command, root_name="chatclash"))
    ctx.exit()


@click.group(context_settings={"help_option_names": ["-h", "--help"]})
@click.version_option(__version__, prog_name="chatclash")
@click.option(
    "--tree",
    is_flag=True,
    is_eager=True,
...
def mihomo_install(repo: str, version: str, dry_run: bool, force: bool, daemon: bool, interactive: bool | None) -> None:
    """Install the local Mihomo binary."""
...
def mihomo_uninstall(dry_run: bool, daemon: bool, interactive: bool | None) -> None:
    """Uninstall the local Mihomo binary."""
...
def mihomo_update(repo: str, version: str, dry_run: bool, interactive: bool | None) -> None:
    """Update the local Mihomo binary."""
...
def mihomo_start(dry_run: bool, interactive: bool | None) -> None:
    """Start the local Mihomo runtime."""
...
def mihomo_restart(dry_run: bool, interactive: bool | None) -> None:
    """Restart the local Mihomo runtime."""
...
def mihomo_status(interactive: bool | None) -> None:
    """Show local Mihomo runtime status."""
...
def mihomo_logs(tail: int, dry_run: bool, interactive: bool | None) -> None:
    """Show local Mihomo runtime logs."""
